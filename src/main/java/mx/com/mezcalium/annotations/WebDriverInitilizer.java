...
import mx.com.mezcalium.web.driver.impl.WebDriverImplementation;
...
public @interface WebDriverInitilizer {

	Class<? extends CustomWebDriverImplementation> customImplementation() default WebDriverImplementation.class;
